...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_ortho_5x15(
      ...
      LCTL_T(KC_ESC) , KC_A    , KC_S          , KC_D    , KC_F    , KC_G   , KC_LGUI     , KC_MPLY , KC_RGUI     , KC_H   , KC_J    , KC_K    , KC_L    , KC_SCLN , KC_QUOT ,
	...
	[_META] = LAYOUT_ortho_5x15(
      ...
      KC_NO , KC_NO , KC_NO , KC_MS_L , KC_MS_D , KC_MS_R , KC_NO   , KC_NO , KC_NO   , KC_NO   , CMB_TOG , KC_NO   , KC_NO   , KC_NO , KC_MPLY ,
