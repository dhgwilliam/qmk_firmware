...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT_ortho_5x15(
      ...
      LCTL_T(KC_ESC) , KC_A    , KC_S          , KC_D    , KC_F    , KC_G   , MOD_LGUI    , KC_MPLY , MOD_RGUI    , KC_H   , KC_J    , KC_K    , KC_L    , KC_SCLN , RCTL_T(KC_QUOT) ,
      KC_LSFT        , KC_Z    , KC_X          , KC_C    , KC_V    , KC_B   , MOD_LALT    , KC_HOME , MOD_RALT    , KC_N   , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , RSFT_T(KC_ENT)  ,
	...
	[_SYMBOL] = LAYOUT_ortho_5x15(
      ...
      KC_NO , KC_NO   , KC_NO , KC_NO   , KC_NO  , KC_NO   , KC_NO     , KC_NO , KC_NO     , KC_NO   , KC_TILD , KC_PIPE , KC_LBRC , KC_RBRC , KC_NO   ,
      KC_NO , KC_NO   , KC_NO , KC_NO   , KC_NO  , KC_NO   , MO(_META) , KC_NO , MO(_META) , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_TRNS
      ),
	[_NUMBER] = LAYOUT_ortho_5x15(
      ...
      KC_NO  , KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 , KC_NO   , KC_NO , KC_NO   , KC_F6 , KC_F7 , KC_F8 , KC_F9 , KC_F10 , KC_BSLS ,
      KC_NO  , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO   , KC_NO , KC_NO   , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO  , KC_NO   ,
      KC_NO  , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO , KC_TRNS , KC_NO , KC_TRNS , KC_NO , KC_NO , KC_NO , KC_NO , KC_NO  , KC_TRNS
      )      ,
